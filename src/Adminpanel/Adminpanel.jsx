...
const AdminPanel = () => {
  ...
  const challengeUsers = [
    { id: 1, username: "serdarkarasulu@hotmail.com", booksCompleted: 0, testScore: 0, subscription: "active" },
    { id: 2, username: "ArtHurKas@gmail.com", booksCompleted: 0, testScore: 0, subscription: "pending" },
    { id: 3, username: "serdarkarasulu", booksCompleted: 0, testScore: 0, subscription: "active" },
    { id: 4, username: "kemalkarasulu@hotmail.com", booksCompleted: 0, testScore: 0, subscription: "active" }
  ];
            ...
            <table className="table table-bordered table-dark">
              ...
              <tbody>
                {filteredChallengeUsers.map((user) => (
                  <tr key={user.id} onClick={() => navigate(`/userDetails/${user.id}`)} style={{ cursor: "pointer" }}>
                    <td>{user.username}</td>
              ...
              <tbody>
                {filteredCommissionUsers.map((user) => (
                  <tr key={user.id} onClick={() => navigate(`/userDetails/${user.id}`)} style={{ cursor: "pointer" }}>
                    <td>{user.username}</td>
                    <td>
                      <span style={{ color: "#ffc107", cursor: "pointer" }} onClick={() => navigate(`/userDetails/${user.id}`)}>
                        {user.promoCode}
                      </span>
                    </td>
                    <td>{user.referrals}</td>
